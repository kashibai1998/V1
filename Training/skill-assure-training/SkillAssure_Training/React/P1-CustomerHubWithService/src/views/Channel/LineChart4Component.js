            ...
            data: {
                ...
                datasets: [
                    ...
                    // },
                    {
                        ...
                        data: [230,250,270,290,310,280,280,270,250,280,300,320,290,280,270,300,310,320,270,260,240,290,310,320,300,315,300,290,310],
                        fill: false,
                        borderWidth: 2,
                        borderColor: 'orange',
                        lineTension: 0,
                    ...
                    },
                    {
                        ...
                        data: [80,120,140,120,150,170,180,190,210,180,170,150,180,170,190,220,240,260,220,190,180,170,180,200,220,230,240,260,250,230],
                        fill: false,
                        borderWidth: 2,
                        borderColor: '#66B968',
                        lineTension: 0,
...

                    {
                        ...
                        //data: [3, 0, 2, 4, 7, 9, 6, 4, 7, 10, 4, 8, 4, 5, 9, 6, 7, 10, 8, 12, 3, 0, 2, 4, 7, 9, 6, 4, 7, 10, 4, 8, 4, 5, 9, 6, 7, 10, 8, 12, 3, 0, 2, 4, 7, 9, 6, 4, 7, 10, 4, 8, 4, 5, 9, 6, 7, 10, 8, 12, 3, 0, 2],
                        data: [50,40,60,120,160,210,180,220,270,310,290,180,160,140,130,150,140,160,140,130,120,110,90,95,130,70,100,120,130,170,210],
                        fill: false,
                        borderWidth: 2,
                        borderColor: '#70A6F9',
                        lineTension: 0,
                    ...
                    },
                    {
                        ...
                        //data: [3, 0, 2, 4, 7, 9, 6, 4, 7, 10, 4, 8, 4, 5, 9, 6, 7, 10, 8, 12, 3, 0, 2, 4, 7, 9, 6, 4, 7, 10, 4, 8, 4, 5, 9, 6, 7, 10, 8, 12, 3, 0, 2, 4, 7, 9, 6, 4, 7, 10, 4, 8, 4, 5, 9, 6, 7, 10, 8, 12, 3, 0, 2],
                        data: [300,320,350,395,370,320,350,420,400,460,420,390,370,340,280,260,250,280,300,320,340,300,370,410,400,390,380,370,360,340],
                        fill: false,
                        borderWidth: 2,
                        borderColor: '#FC806C',
                        lineTension: 0,
