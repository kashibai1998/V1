...
//for invoice.
	...
	List<Product> getProductsBySupllierId(@Param("supplier_id") UUID id);
//	 
//	@Query(value = "select p from Product p where p.supplier_id =:supplierId")
//	List<Product> getBySupllierId(@Param("supplier_id") UUID supplierId);
