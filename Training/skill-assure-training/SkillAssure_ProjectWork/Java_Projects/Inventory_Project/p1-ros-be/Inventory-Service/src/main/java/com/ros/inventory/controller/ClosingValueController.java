...
public class ClosingValueController {
	...
	@ResponseBody
	@Operation(summary="It will return upcoming closing list of items")
	...
	@ResponseBody
	@Operation(summary="It is use to save list in draft")
	...
	//-----------close stock 
		...
		@ResponseBody
		@Operation(summary="It is use for summit the close stock list")
		public ResponseEntity<?> closeStock(@RequestBody List<ClosingValueDto> close_value) throws InventoryException{
			ResponseEntity<?> response;
			response=new ResponseEntity(iclosingValue.closeStock(close_value),HttpStatus.OK);
			return response;
		}
}
