...
public interface ISupplierManager {
	...
	SupplierDto saveSupplier(SupplierDto supply) throws InventoryException;
	...
	InternalSupplierDto saveInternalSupplier(InternalSupplierDto internalSupplierDto) throws InventoryException;

	List<Product> getProducts(UUID id) throws InventoryException;
