...
public class ProductManager implements IProductManager {
	...
	@Override
	public ProductDto addProduct(ProductDto productDto) throws InventoryException {

		return mapper.convertToDto(productRepo.save(mapper.convertToEntity(productDto)));
	}
