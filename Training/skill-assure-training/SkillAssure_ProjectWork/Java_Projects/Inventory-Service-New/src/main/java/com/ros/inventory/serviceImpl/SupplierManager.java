...
public class SupplierManager implements ISupplierManager {
	...
	@Override
	public SupplierDto saveSupplier(SupplierDto supply) throws InventoryException {

		return supplierMapper.convertToSupplierDto(supplyRepo.save(supplierMapper.convertToSupplierEntity(supply)));
	}

	@Override
	public InternalSupplierDto saveInternalSupplier(InternalSupplierDto internalSupplierDto) throws InventoryException {

		return supplierMapper.convertToInternalSupplierDto(
				supplyRepo.save(supplierMapper.convertToInternalSupplierEntity(internalSupplierDto)));
	}

	@Override
	public List<Product> getProducts(UUID id) throws InventoryException {
		// TODO Auto-generated method stub
		Supplier supplierFromDB = supplyRepo.getById(id);
		System.out.println("Supplier ID is: " + supplierFromDB.getSupplierId());
		List<Product> products = supplyRepo.getProductsBySupllierId(supplierFromDB.getSupplierId());
