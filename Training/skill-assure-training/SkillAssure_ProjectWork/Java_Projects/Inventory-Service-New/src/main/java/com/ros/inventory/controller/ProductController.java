...
//
//	/*
//	 * ----------------- FOR DISPLAYING THE LIST OF PRODUCT THAT PARTICULAR SUPPLIER
//	 * HAS ---------------------------
//	 */
//	/*--------------- HERE WE HAVE TO PASS SUPPLIER ID------------------*/
//	@GetMapping("/show/{id}")
//	@ResponseBody
//	@Operation(summary = "gets list of product for a supplier")
...
//		ResponseEntity response;
//		try {
//			response = new ResponseEntity<ProductDto>(productmanager.addProduct(productDto), HttpStatus.OK);
//		} catch (InventoryException e) {
//			response = new ResponseEntity(e.getMessage(), HttpStatus.OK);
//			e.printStackTrace();
//		}
